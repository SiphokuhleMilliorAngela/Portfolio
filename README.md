...
- **Result:** Delivered a scalable software that was   fully functional , improved
  load time, launched on time.
...
- **Task:** Built a digital system to automate and simplify the enrolment
  process.
- **Action:** Used `Java` & `Derby Databases`
  to create a form-based system with data validation and record management.
